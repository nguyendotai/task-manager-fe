  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <span className="grid size-9 shrink-0 place-items-center rounded-2xl border border-gray-200 text-gray-400 transition group-hover:border-blue-200 group-hover:text-blue-600 dark:border-zinc-800 dark:group-hover:border-blue-900/70 dark:group-hover:text-blue-500">
