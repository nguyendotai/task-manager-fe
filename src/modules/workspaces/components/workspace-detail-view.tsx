    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-between">
        <div className="flex gap-3 sm:items-center">
          ...
          <div className="grid size-16 place-items-center rounded-2xl bg-blue-50 text-xl font-black text-blue-600 dark:bg-blue-950/40 dark:text-blue-400">
            {selectedWorkspace.name.slice(0, 2).toUpperCase()}
          </div>
        </div>
          <h1 className="text-3xl font-bold tracking-normal  text-blue-600 dark:text-blue-500">
          ...
          <div className="grid min-h-72 place-items-center rounded-2xl border border-dashed border-gray-300 bg-white p-8 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <div className="max-w-md">
              ...
              <p className="mt-2 text-sm leading-6 text-gray-500 dark:text-zinc-400">
                Create the first board for this workspace from the action button
                above.
              </p>
            </div>
          </div>
